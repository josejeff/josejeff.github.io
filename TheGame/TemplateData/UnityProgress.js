function UnityProgress (dom) {
	...
	logoImage.src = "TheGame/TemplateData/Logo." + splashStyle + ".png";
	logoImage.style.position = "absolute";
	parent.appendChild(logoImage);
	this.logoImage = logoImage;

	var progressFrame = document.createElement("img");
	progressFrame.src = "TheGame/TemplateData/ProgressFrame." + splashStyle + ".png";
	...
	progressBarImg.src = "TheGame/TemplateData/ProgressBar." + splashStyle + ".png";
